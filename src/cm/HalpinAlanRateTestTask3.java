...
public class HalpinAlanRateTestTask3 {
    ...
    // No discount on cost less than 5.50
    @Test
    ...
    public void testCase38()
    {
        ...
        r = new Rate(x, normalRate, reducedRate,reducedPeriods, normalPeriods);
        assertEquals(BigDecimal.valueOf(10), r.calculate(normalPeriod1)); // Actual 6.625
    }
    @Test (expected = AssertionError.class)
    ...
    public void testCase40()
    {
        ...
        Period normalPeriod1 = new Period(8,16);
        Period reducedPeriod1 = new Period(16,24);
        ...
        Period parking = new Period(10,16);

        assertEquals(BigDecimal.valueOf(24), r.calculate(parking)); // actual is 8
    }
    // Management free hour test
    @Test
    public void testCase41()
    {
        ...
        Period normalPeriod1 = new Period(0,16);
        Period reducedPeriod1 = new Period(16,23);
        ...
        Period parking = new Period(23,24);
    ...
    public void testCase42()
    {
        ...
        Period parking = new Period(14,20);

        assertEquals(BigDecimal.valueOf(12), r.calculate(parking)); //
    }
